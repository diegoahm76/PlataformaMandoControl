...
from geojson.choices.agrupacion_documental_choices import agrupacion_documental_CHOICES
from geojson.choices.tipo_unidad_choices import tipo_unidad_CHOICES
from geojson.choices.tipo_cambio_masivo_choices import tipo_cambio_masivo_CHOICES
...
class CambiosUnidadMasivos(models.Model):
    ...
    id_persona_cambio=models.ForeignKey('geojson.Personas', on_delete=models.CASCADE, db_column='T025Id_PersonaCambio')
...
class TemporalPersonasUnidad(models.Model):
    ...
    id_persona=models.OneToOneField('geojson.Personas', on_delete=models.CASCADE, db_column='T026Id_Persona')

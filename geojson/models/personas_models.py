...
from geojson.choices.tipo_persona_choices import tipo_persona_CHOICES
from geojson.choices.cod_naturaleza_empresa_choices import cod_naturaleza_empresa_CHOICES
...
class Personas(models.Model):
    ...
    tipo_documento = models.ForeignKey('geojson.TipoDocumento', on_delete=models.CASCADE, db_column='T010Cod_TipoDocumentoID')
    numero_documento = models.CharField(max_length=20, db_column='T010nroDocumentoID')
    cod_municipio_expedicion_id = models.ForeignKey('geojson.Municipio', related_name='cod_municipio_expedicion_id', on_delete=models.SET_NULL, null=True, blank=True, db_column='T010Cod_MunicipioExpID')
    ...
    municipio_residencia = models.ForeignKey('geojson.Municipio', related_name='municipio_residencia', on_delete=models.SET_NULL, null=True, blank=True, db_column='T010Cod_MunicipioResidenciaNal')
    pais_residencia = models.ForeignKey('geojson.Paises', related_name='pais_residencia', on_delete=models.SET_NULL, null=True, blank=True, db_column='T010Cod_PaisResidenciaExterior')
    direccion_laboral = models.CharField(max_length=255, null=True, blank=True, db_column='T010dirLaboralNal')
    cod_municipio_laboral_nal = models.ForeignKey('geojson.Municipio', related_name='cod_municipio_laboral_nal', on_delete=models.SET_NULL, null=True, blank=True, db_column='T010Cod_MunicipioLaboralNal')
    ...
    cod_municipio_notificacion_nal = models.ForeignKey('geojson.Municipio', related_name='cod_municipio_notificacion_nal', on_delete=models.SET_NULL, null=True, blank=True, db_column='T010Cod_MunicipioNotificacionNal')
    ...
    cod_pais_nacionalidad_empresa = models.ForeignKey('geojson.Paises', related_name='cod_pais_nacionalidad_empresa', on_delete=models.SET_NULL, null=True, blank=True, db_column='T010Cod_PaisNacionalidadDeEmpresa')
    ...
    pais_nacimiento = models.ForeignKey('geojson.Paises', on_delete=models.SET_NULL, null=True, blank=True, db_column='T010Cod_PaisNacimiento')
    sexo = models.ForeignKey('geojson.Sexo', on_delete=models.SET_NULL, null=True, blank=True, db_column='T010Cod_Sexo')
    estado_civil = models.ForeignKey('geojson.EstadoCivil', related_name="estado_civil", on_delete=models.SET_NULL, null=True, blank=True, db_column='T010Cod_EstadoCivil')
    id_cargo = models.ForeignKey('geojson.Cargos', on_delete=models.SET_NULL, null=True, blank=True, db_column='T010Id_CargoActual')

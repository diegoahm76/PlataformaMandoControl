...
from geojson.models.expedientes_models import ArchivosDigitales, ExpedientesDocumentales
from geojson.models.notificaciones_models import NotificacionesCorrespondencia
from geojson.models.radicados_models import Anexos, EstadosSolicitudes, MediosSolicitud, T262Radicados
from geojson.models.base_models import Municipio, TipoDocumento
from geojson.models.entidades_models import SucursalesEmpresas
from geojson.choices.cod_tipo_operacion_tramite_choices import cod_tipo_operacion_tramite_CHOICES
from geojson.choices.codigo_relacion_titular_choices import cod_relacion_persona_titular_CHOICES
from geojson.choices.cod_calendario_habiles_choices import cod_calendario_habiles_CHOICES
from geojson.choices.cod_tipo_permiso_ambiental_choices import cod_tipo_permiso_ambiental_CHOICES
from geojson.choices.cod_tipo_predio_choices import cod_tipo_predio_CHOICES
from geojson.choices.cod_clasificacion_territorial_choices import cod_clasificacion_territorial_CHOICES
from geojson.choices.cod_tipo_calidad_persona_choices import cod_tipo_calidad_persona_CHOICES
from geojson.choices.cod_tipo_desistimiento_choices import cod_tipo_desistimiento_CHOICES
from geojson.choices.cod_tipo_solicitud_al_requerimiento_choices import cod_tipo_solicitud_al_requerimiento_CHOICES
from geojson.choices.cod_tipo_solicitud_juridica_choices import cod_tipo_solicitud_juridica_CHOICES
from geojson.choices.cod_estado_solicitud_juridica_choices import cod_estado_solicitud_juridica_CHOICES

from geojson.models.personas_models import Personas
from geojson.models.pagos_models import Pagos
...
class SolicitudesTramites(models.Model):
    ...
    id_pago_evaluacion = models.ForeignKey(Pagos, on_delete=models.SET_NULL, null=True, blank=True, db_column='T273Id_PagoEvaluacion')
...
class ActosAdministrativos(models.Model):
    ...
    id_consec_por_nivel_tipologias_doc_agno = models.ForeignKey('geojson.ConsecutivoTipologia', on_delete=models.CASCADE, db_column='T294Id_ConsecPorNivel_TipologiasDocAgno')
    id_notificacion = models.ForeignKey(NotificacionesCorrespondencia,on_delete=models.SET_NULL,db_column='T294Id_Notificacion',null=True)
    fecha_notificacion = models.DateTimeField(db_column='T294fechaNotificacion',null=True)
    ...
    id_persona_publica_acto = models.ForeignKey(Personas, on_delete=models.SET_NULL, db_column='T294Id_PersonaPublicaActo',null=True)
    estado_actual = models.IntegerField(db_column='T294estadoActual',null=True)

...
from geojson.models.ccd_models import CatalogosSeriesUnidad, CuadrosClasificacionDocumental 
from geojson.choices.tipos_medios_doc_choices import tipos_medios_doc_CHOICES
from geojson.choices.cod_nivel_consecutivo_choices import cod_nivel_consecutivo_CHOICES
...
from geojson.models.plantillas_models import PlantillasDoc
...
class CatSeriesUnidadOrgCCDTRD(models.Model):
    ...
    descripcion_procedimiento = models.CharField(max_length=10000, null=True, blank=True, db_column='T218descripcionProcedimiento')
    ...
    ruta_archivo_cambio = models.ForeignKey('geojson.ArchivosDigitales', on_delete=models.SET_NULL, blank=True, null=True, db_column='T218rutaArchivoCambio')
...
class HistoricosCatSeriesUnidadOrgCCDTRD(models.Model):
    ...
    descripcion_procedimiento = models.CharField(max_length=10000, db_column='T219descripcionProcedimiento')
    ...
    ruta_archivo = models.ForeignKey('geojson.ArchivosDigitales', on_delete=models.SET_NULL, blank=True, null=True, db_column='T219rutaArchivoCambio')
...
class ConsecutivoTipologia(models.Model):
    ...
    id_plantilla_doc = models.ForeignKey(PlantillasDoc, on_delete=models.SET_NULL, db_column='T319Id_Plantilla_Doc', blank=True, null=True)
    id_tipologia_doc = models.ForeignKey(TipologiasDoc, on_delete=models.CASCADE, db_column='T319Id_TipologiaDoc')
    CatalogosSeriesUnidad = models.ForeignKey('geojson.CatalogosSeriesUnidad',blank=True,null=True ,on_delete=models.SET_NULL, db_column='T329Id_CatalogoSeriesUnidad',related_name='T319Id_CatalogoSeriesUnidad')
    ...
    id_radicado = models.ForeignKey('geojson.T262Radicados', on_delete=models.SET_NULL, db_column='T319Id_Radicado', related_name='T319Id_Radicado', blank=True, null=True)
    ...
    id_archivo_digital_copia = models.ForeignKey('geojson.ArchivosDigitales', on_delete=models.SET_NULL, db_column='T319Id_ArchivoDigitalCopia', related_name='T319Id_ArchivoDigitalCopia', blank=True, null=True)
    id_archivo_digital = models.ForeignKey('geojson.ArchivosDigitales', on_delete=models.SET_NULL, db_column='T319Id_ArchivoDigital', related_name='T319Id_ArchivoDigital', blank=True, null=True)
    id_PQRSDF = models.ForeignKey('geojson.PQRSDF', on_delete=models.SET_NULL, db_column='T319Id_PQRSDF', related_name='T319Id_PQRSDF', blank=True, null=True)
    id_tramite = models.ForeignKey('geojson.SolicitudesTramites', on_delete=models.SET_NULL, db_column='T319Id_Tramite', related_name='T319Id_Tramite', blank=True, null=True) 
    id_notificaciones_correspondencia = models.ForeignKey('geojson.NotificacionesCorrespondencia', on_delete=models.SET_NULL, db_column='T319Id_NotificacionesCorrespondencia', related_name='T319Id_NotificacionesCorrespondencia', blank=True, null=True)
    class Meta:

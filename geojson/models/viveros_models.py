...
from geojson.choices.tipo_vivero_choices import tipo_vivero_CHOICES
from geojson.choices.origen_recursos_vivero_choices import origen_recursos_vivero_CHOICES
...
class Vivero(models.Model):
    ...
    coordenadas_lat = models.DecimalField(max_digits=18, decimal_places=13, blank=True, null=True, db_column='T150coordenadasLat')
    coordenadas_lon = models.DecimalField(max_digits=18, decimal_places=13, blank=True, null=True, db_column='T150coordenadasLon')
    ...
    ruta_archivo_creacion = models.ForeignKey('gestion_documental.ArchivosDigitales', on_delete=models.CASCADE, db_column='T150rutaArchivoCreacion')

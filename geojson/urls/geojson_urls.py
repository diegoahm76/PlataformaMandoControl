...
urlpatterns=[
    ...
    path('tramite/expedientes/get/',tramites_views.GeoJsonExpedientesView.as_view(),name='geojson-expedientes'),
    path('tramite/licencia_ambiental_no_convencional/get/',tramites_views.GeoJsonLicenciaAmbientalNoConvencionalView.as_view(),name='geojson-licencia-ambiental-no-convencional'),
    path('tramite/licencia_ambiental_transferencia_fotovoltaica/get/',tramites_views.GeoJsonLicenciaAmbientalTransferenciaFotovoltaicaView.as_view(),name='geojson-licencia-ambiental-transferencia-fotovoltaica'),
    path('tramite/licencia_ambiental_rellenos_sanitarios/get/',tramites_views.GeoJsonLicenciaAmbientalRellenosSanitariosView.as_view(),name='geojson-licencia-ambiental-rellenos-sanitarios'),
    path('tramite/licencia_ambiental_aprovechamiento_residuos_organicos/get/',tramites_views.GeoJsonLicenciaAmbientalAprovechamientoResiduosOrganicosView.as_view(),name='geojson-licencia-ambiental-aprovechamiento-residuos-organicos'),
    path('tramite/medidas_manejo_ambiental/get/',tramites_views.GeoJsonMedidasManejoAmbientalView.as_view(),name='geojson-medidas-manejo-ambiental'),
